...
const PRIVKEY =
  "81cbdb9c82bcb6067ca96ca0e754bb3d3efd1b813281010e392256c642de1064";
const PUBKEY =
  "8a5a685420091ae0abef79be1735921b6bab047cc5b2aaefb8f8902dedf117f5";
...
test("decrypt works", function (t) {
  t.plan(1);
  const dm = {
    id: "62cfada0ff663ba225b67dd2c089242cdfd2c05107bd3d871cec8cee3dcf8ae2",
    pubkey: "8a5a685420091ae0abef79be1735921b6bab047cc5b2aaefb8f8902dedf117f5",
    created_at: 1669439828,
    kind: 4,
    tags: [
      ["p", "8a5a685420091ae0abef79be1735921b6bab047cc5b2aaefb8f8902dedf117f5"],
    ],
    content: "01xFLdntA3rg+L1F+mGUug==?iv=P3yubTIbGbB+Nvi2qtsw0A==",
    sig: "f52a550ff18ca3cedfdf3c108744c7bd3cdde601c5b014ead814967c4bafe5c87735d32f8734a337d6a271b519d29a0fc863141197bdc6253a3a19c7488ebbff",
  };
...
test("create delegate event", async function (t) {
  const publisher_privkey =
    "d78578125f35cfc39fab89427d4086be1f0db939c393efd311631776a8e5d9ca";
  ...
  const delegate_ev = await createDelegationEvent(
    publisher_privkey,
    ev,
    delegation
  );
...
test("sign delegation token", async function (t) {
  ...
  const unsigned_token =
    "nostr:delegation:fa11cadbb65d6e81ae4e18a09ab7d784ea87d8b5c18bc81ece76b088fa0d1f5b:kind=1&created_at>1668780345&created_at<1700317277";
...
test("calculate event id", async function (t) {
  ...
  t.equal(
    id,
    "c690044fedd4fb2a7a3c4757f9deb1be4893e81605a5ae9c04f99a189c2810dd"
  );
});
...
test("connect to multiple works", function (t) {
  ...
  pool.on("open", (relay) => {
    t.equal(
      true,
      relay.url === damus || relay.url === scsi,
